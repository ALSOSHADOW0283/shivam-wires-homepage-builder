          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                <Factory className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-gray-900">Modern Manufacturing</h4>
                  <p className="text-gray-600 text-sm">State-of-the-art production facility</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Agra Based</h4>
                  <p className="text-gray-600 text-sm">Strategic location for pan-India supply</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">ISO standards and quality assurance</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">B2B Focus</h4>
                  <p className="text-gray-600 text-sm">Dedicated industrial partnerships</p>
                </div>
              </div>
            </div>
          </div>
